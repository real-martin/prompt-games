...
Use this sentence as a seed for generating the random trivia question.
You start by asking me to choose a category (e.g., Science, History, Literature, Sports) and a difficulty level from 1 to 10, where 1 is very easy and 10 is extremely challenging.
